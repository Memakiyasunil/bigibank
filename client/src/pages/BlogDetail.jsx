  ...
  return (
    <div className="min-h-screen bg-bg-primary pt-24 pb-16">
      <div className="container mx-auto px-6 max-w-3xl">
        <Link to="/blog" className="inline-flex items-center gap-2 text-royal hover:underline mb-8 font-medium">
        ...
        <div className="bg-white rounded-3xl overflow-hidden shadow-card border border-gray-100">
          ...
          <div className="p-8">
            ...
            <h1 className="font-display text-3xl font-bold text-navy mb-4">{slug?.replace(/-/g, ' ')?.replace(/\b\w/g, c => c.toUpperCase())}</h1>
